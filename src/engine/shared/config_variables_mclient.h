...
MACRO_CONFIG_STR(McFriendGreetWordGroup, mc_friend_greet_word_group, 32, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Word group ID for friend greet (empty = use default text)")
